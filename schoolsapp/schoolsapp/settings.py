"""
Django settings for schoolsapp project.
...
SECRET_KEY = '^%0_vi4l88@!swvcd)(h@han^en3z=50d6=^vlzxgi2!(&4$f!'
...
WSGI_APPLICATION = 'schoolsapp.wsgi.application'
