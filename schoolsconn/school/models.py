...
class School(models.Model):
    ...
    ncce = models.BooleanField(_('National Common Entrance Examinations'), default=False)
    scce = models.BooleanField(_('State Common Entrance Examinations'), default=False)
    waec = models.BooleanField(_('Senior West African Examination Council Exams'), default=False)
    neco = models.BooleanField(_('Senior National Examination Council Exams'), default=False)
    jwaec = models.BooleanField(_('Junior West African Examination Council Exams'), default=False)
    jneco = models.BooleanField(_('Junior National Examination Council Exams'), default=False)
    toefl = models.BooleanField(_('TOEFL Examinations'), default=False)
    ielts = models.BooleanField(_('IELTS Examinations'), default=False)
    alevel = models.BooleanField(_('A-Levels Examinations'), default=False)
    igcse = models.BooleanField(_('IGCSE Examinations'), default=False)
    ...
    jets = models.BooleanField(default=False)
    karate = models.BooleanField(default=False)
